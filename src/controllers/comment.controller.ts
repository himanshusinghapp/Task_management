...
export class CommentController {
  async addComment(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      return res.status(HTTP_STATUS.CREATED).json(ResponseHelper.created('Comment added successfully', result));
    } catch (err: any) {
  ...
  async getCommentsByTask(req: Request, res: Response) {
    try {
      ...
      return res.status(HTTP_STATUS.OK).json(ResponseHelper.success('Comments fetched successfully', result));
    } catch (err: any) {
  ...
  async updateComment(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      return res.status(HTTP_STATUS.OK).json(ResponseHelper.success('Comment updated successfully', result));
    } catch (err: any) {
  ...
  async deleteComment(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      return res.status(HTTP_STATUS.OK).json(ResponseHelper.success('Comment deleted successfully', result));
    } catch (err: any) {
