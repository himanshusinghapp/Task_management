...
import { logMessage, logControllerMethod, logControllerError } from '@utils';
...
export class ProjectController {
  async createProject(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      logControllerMethod('ProjectController', 'createProject', LOGGER_MESSAGES.CREATE, { userId: user._id, role: user.role });
      ...
      logControllerError('ProjectController', 'createProject', err, { userId: req.user?._id, role: req.user?.role, });
      return next(err);
    }
  }
  ...
  async updateProject(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      logControllerMethod('ProjectController', 'updateProject', LOGGER_MESSAGES.UPDATE, { projectId, userId: user._id, role: user.role, updateData: Object.keys(body)});
      ...
      logControllerError('ProjectController', 'updateProject', err, { projectId: req.params.projectId, userId: req.user?._id, role: req.user?.role, updateData: Object.keys(req.body) });
      return next(err);
    }
  }
  ...
  async deleteProject(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      const { user } = req;
      const { projectId } = req.params;
      logControllerMethod('ProjectController', 'deleteProject', LOGGER_MESSAGES.DELETE, { projectId, userId: user._id, role: user.role });
      ...
      logControllerError('ProjectController', 'deleteProject', err, { projectId: req.params.projectId, userId: req.user?._id, role: req.user?.role});
      return next(err);
    }
  }
  ...
  async assignMembers(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      logControllerMethod('ProjectController', 'assignMembers', `Member assignment request received`, { projectId, userId, memberCount: body.memberIds.length });
      ...
      logControllerError('ProjectController', 'assignMembers', err, { projectId: req.params.projectId, userId: req.user._id });
  ...
  async removeMembers(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      logControllerMethod('ProjectController', 'removeMembers', `Member removal request received`, { projectId, userId, memberCount: body.memberIds.length});
      ...
      logControllerError('ProjectController', 'removeMembers', err, { projectId: req.params.projectId, userId: req.user._id });
  ...
  async assignTasks(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      logControllerMethod('ProjectController', 'assignTasks', `Task assignment request received`, { projectId, userId, taskCount: body.taskIds.length});
      ...
      logControllerError('ProjectController', 'assignTasks', err, { projectId: req.params.projectId, userId: req.user._id });
  ...
  async removeTasks(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      logControllerMethod('ProjectController', 'removeTasks', `Task removal request received`, { projectId, userId, taskCount: body.taskIds.length});
      ...
      logControllerError('ProjectController', 'removeTasks', err, { projectId: req.params.projectId, userId: req.user._id });
      logMessage('error', LOGGER_MESSAGES.UPDATE, { error: err.message });
      return next(err);
    }
  }
  ...
  async getProjects(req: AuthenticatedRequest, res: Response, next: NextFunction) {
    try {
      ...
      logControllerMethod('ProjectController', 'getProjects', `Get projects request received`, { userId, role});
      ...
      logControllerError('ProjectController', 'getProjects', err, { userId: req.user._id, role: req.user.role});
      return next(err);
    }
  }
}
